...
namespace Steam_Data_Collection
{
    internal static class GetInformation
    {
        ...
        {
            var users = "Number of users: " + Program.Count("SELECT COUNT(1) FROM tbl_user;");
            var friend = "Number of seperate friend relations: " +
                         Program.Count("SELECT COUNT(1) FROM tbl_friend;");
            var gcollectionlink = "Number of library screenings: " +
                                  Program.Count("SELECT COUNT(1) FROM tbl_gcollectionlink;");
            var gcollection = "Number of game screenings: " +
                              Program.Count("SELECT COUNT(1) FROM tbl_gcollection;");
            var games = "Number of games collected: " + Program.Count("SELECT COUNT(1) FROM tbl_games;");
        ...
        public static List<User> SevenDegrees(List<User> user)
        {
